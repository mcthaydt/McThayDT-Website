...
async function seed() {
  ...
  await db.delete(schema.funFacts);
  await db.delete(schema.personalStats);
  ...
  // Personal Stats
  await db.insert(schema.personalStats).values([
    // Big 5
    { category: "big5", label: "Openness", valueNum: 96, order: 1 },
    { category: "big5", label: "Conscientiousness", valueNum: 92, order: 2 },
    { category: "big5", label: "Extraversion", valueNum: 45, order: 3 },
    { category: "big5", label: "Agreeableness", valueNum: 55, order: 4 },
    { category: "big5", label: "Neuroticism", valueNum: 35, order: 5 },
    // Text Stats
    { category: "mbti", label: "Myers-Briggs", valueText: "INTJ-A", order: 1 },
    { category: "mbti", label: "Enneagram", valueText: "Type 5w6", order: 2 },
    // Astrology
    { category: "astrology", label: "Sun", valueText: "Scorpio", order: 1 },
    { category: "astrology", label: "Moon", valueText: "Aquarius", order: 2 },
    { category: "astrology", label: "Rising", valueText: "Virgo", order: 3 },
    { category: "astrology", label: "Mercury", valueText: "Scorpio", order: 4 },
    { category: "astrology", label: "Venus", valueText: "Capricorn", order: 5 },
    { category: "astrology", label: "Mars", valueText: "Virgo", order: 6 },
  ]);
  ...
  for (const [category, items] of Object.entries(funFactsData)) {
